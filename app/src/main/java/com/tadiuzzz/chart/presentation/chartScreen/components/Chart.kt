    ...
    Column(
        ...
        Capturable(
            ...
            onCaptured = { bitmap, error ->
                if (bitmap != null) {
                    Log.d("Capture", "Bitmap captured")
                    onChartCaptured(bitmap.asAndroidBitmap())
                }

                if (error != null) {
                    Log.e("Capture", "Error capturing bitmap")
                }
            }
        ) {
            Canvas(
                ...
                val linesCountYPositive =
                    (canvasHeight - (canvasHeight - center.y)) / offsetYPositive
